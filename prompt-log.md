# Prompt Log — AI Chatbot Build Session

A chronological record of every prompt submitted during the chatbot feature build.
...
**[2]**
> Done. I put the localhost in to test locally. Now how do i test locally, do i do npm run dev or something in the terminal?
...
**[6]**
> I made a new key: [REDACTED] Where do i have to update it besides on .env? do i have to update it on my render.com web service?
